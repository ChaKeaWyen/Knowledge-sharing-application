    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 39.1, middle: 0.3969),
            Pin(size: 38.6, end: 24.9),
            child: SvgPicture.string(
              _svg_ni2vgy,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
